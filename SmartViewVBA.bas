...
Enum HYP_SVC_OPTIONS_INDEX
    ...
    HSV_INVALID_LABEL
    HSV_SUBMITZERO
    HSV_19 'unused reserved for future use
    HSV_20 'unused reserved for future use
    HSV_PRESERVE_FORMULA_COMMENT
    HSV_22 'unused reserved for future use
    HSV_FORMULA_FILL
    ...
    HSV_UNDO_ENABLE
    HSV_103 'unused reserved for future use
...
Public Declare PtrSafe Function HypSetBackgroundPOV Lib "HsAddin" (ByVal vtFriendlyName, _
                                                           ParamArray MemberList() As Variant) As Long

Public Declare PtrSafe Function HypSetPages Lib "HsAddin" (ByVal vtSheetName, _
                                                   ParamArray MemberList() As Variant) As Long

Public Declare PtrSafe Function HypSetPOV Lib "HsAddin" (ByVal vtSheetName, _
                                                 ParamArray MemberList() As Variant) As Long

Public Declare PtrSafe Function HypSetMembers Lib "HsAddin" (ByVal vtSheetName, _
                                                            ByVal vtDimensionName As Variant, _
                                                            ParamArray MemberList() As Variant) As Long
...
Public Declare PtrSafe Function HypGetDimensions Lib "HsAddin" (ByVal vtSheetName, _
                                                 ByRef vtMemberNames As Variant, ByRef vtType As Variant) As Long
...
Public Declare PtrSafe Function HypSetDimensions Lib "HsAddin" (ByVal vtSheetName, _
                                                              ByRef vtDimNames() As Variant, _
                                                              ByRef vtTypes() As Variant) As Long
...
Public Declare Function HypSetBackgroundPOV Lib "HsAddin" (ByVal vtFriendlyName, _
                                                           ParamArray MemberList() As Variant) As Long

Public Declare Function HypSetPages Lib "HsAddin" (ByVal vtSheetName, _
                                                   ParamArray MemberList() As Variant) As Long

Public Declare Function HypSetPOV Lib "HsAddin" (ByVal vtSheetName, _
                                                 ParamArray MemberList() As Variant) As Long

Public Declare Function HypSetMembers Lib "HsAddin" (ByVal vtSheetName, _
                                                            ByVal vtDimensionName As Variant, _
                                                            ParamArray MemberList() As Variant) As Long
Public Declare Function HypGetPOV Lib "HsAddin" (ByVal vtSheetName, _
                                                 ByRef vtDimensionNames As Variant, _
                                                 ByRef vtMemberNames As Variant, ByRef vtType As Variant) As Long
Public Declare Function HypGetDimensions Lib "HsAddin" (ByVal vtSheetName, _
                                                 ByRef vtMemberNames As Variant, ByRef vtType As Variant) As Long
